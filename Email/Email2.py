...
def Fenetre6(Expe, Obj, Msg):
    ...
    TestButton = Button(fenetre6, text="Test Envoi", font="Arial 16", command=lambda: Envoi_Mail("testpythonmailexo@gmail.com",Obj,"testpythonexo", Msg, MailText.get()))
    TestButton.place(relx=0.5, rely=0.4, anchor=CENTER)
    SendList = Button(fenetre6, text="Envoi à la liste", font="Arial 16", command=lambda: Envoi_Mail("testpythonmailexo@gmail.com",Obj,"testpythonexo", Msg, MailText.get()))
